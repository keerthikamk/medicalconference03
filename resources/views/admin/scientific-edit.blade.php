...
@section('title','Admin - Scientific Sessions - Edit')
@section('sidebar')
            ...
            <form method="post" action="/admin/scientifics/{{ $scientific->id }}">
              ...
              <div class="mt-3">
                <label class="block">
                  ...
                  <a href="/admin/scientifics/{{ $scientific->id }}" class="btn bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
