            ...
            <div class="flex h-[calc(100%-4.5rem)] grow flex-col">
              <div class="is-scrollbar-hidden grow overflow-y-auto">
                ...
                >
                  <li>
                    <a
                      ...
                      class="group flex space-x-2 rounded-lg p-2 tracking-wide outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600"
                      @else
                      class="group flex space-x-2 rounded-lg p-2 tracking-wide outline-none transition-all bg-primary/10 text-primary dark:bg-accent-light/10 dark:text-accent-light"
                      @endif
                    >
                      ...
                      @if($unread)
                      <span class="text-primary dark:text-accent-light">{{ $unread }}</span>
                      @endif
                    </a>
                  </li>
                  <li>
                    <a
                      href="/admin/mails?label=archive"
                      @if(request()->get('label') == 'archive')
                      class="group flex space-x-2 rounded-lg p-2 tracking-wide outline-none transition-all bg-primary/10 text-primary dark:bg-accent-light/10 dark:text-accent-light"
                      @else
                      class="group flex space-x-2 rounded-lg p-2 tracking-wide outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600"
                      @endif
                  ...
                  <li>
                    <a
                      href="/admin/mails?label=spam"
                      @if(request()->get('label') == 'spam')
                      class="group flex space-x-2 rounded-lg p-2 tracking-wide outline-none transition-all bg-primary/10 text-primary dark:bg-accent-light/10 dark:text-accent-light"
                      @else
                      class="group flex space-x-2 rounded-lg p-2 tracking-wide outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600"
                      @endif
                  ...
                  <li>
                    <a
                      href="/admin/mails?label=trash"
                      @if(request()->get('label') == 'trash')
                      class="group flex space-x-2 rounded-lg p-2 tracking-wide outline-none transition-all text-error bg-primary/10 dark:bg-accent-light/10 dark:text-error-100"
                      @else
                      class="group flex space-x-2 rounded-lg p-2 tracking-wide outline-none transition-all text-error hover:bg-slate-100 focus:bg-slate-100 dark:text-error-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600"
                      @endif
                    >
                      <div class="flex items-center space-x-2">
                        <svg
                ...
                >
                  <li>
                    <a
                      href="/admin/mails?status=starred"
                      @if(request()->get('status') == 'starred')
                      class="group flex space-x-2 rounded-lg p-2 tracking-wide outline-none transition-all bg-primary/10 text-primary dark:bg-accent-light/10 dark:text-accent-light"
                      @else
                      class="group flex space-x-2 rounded-lg p-2 tracking-wide outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600"
                      @endif
                  ...
                  <li>
                    <a
                      href="/admin/mails?label=saved"
                      @if(request()->get('label') == 'saved')
                      class="group flex space-x-2 rounded-lg p-2 tracking-wide outline-none transition-all bg-primary/10 text-primary dark:bg-accent-light/10 dark:text-accent-light"
                      @else
                      class="group flex space-x-2 rounded-lg p-2 tracking-wide outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600"
                      @endif
                  ...
                  <li>
                    <a
                      href="/admin/mails?label=work"
                      @if(request()->get('label') == 'work')
                      class="group flex space-x-2 rounded-lg p-2 tracking-wide outline-none transition-all bg-primary/10 text-primary dark:bg-accent-light/10 dark:text-accent-light"
                      @else
                      class="group flex space-x-2 rounded-lg p-2 tracking-wide outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600"
                      @endif
                  ...
                  <li>
                    <a
                      href="/admin/mails?label=personal"
                      @if(request()->get('label') == 'personal')
                      class="group flex space-x-2 rounded-lg p-2 tracking-wide outline-none transition-all bg-primary/10 text-primary dark:bg-accent-light/10 dark:text-accent-light"
                      @else
                      class="group flex space-x-2 rounded-lg p-2 tracking-wide outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600"
                      @endif
